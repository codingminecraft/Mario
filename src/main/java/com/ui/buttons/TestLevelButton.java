...
public class TestLevelButton extends JButton {
    String text = "Test Level";
    Vector2f stringPos = new Vector2f();

    private Label label;

    public TestLevelButton() {
        super();
    ...
    public String serialize(int tabSize) {
        ...
        builder.append(beginObjectProperty("TestLevelButton", tabSize));
        builder.append(closeObjectProperty(tabSize));
        return builder.toString();
    }

    public static TestLevelButton deserialize() {
        Parser.consumeEndObjectProperty();

        return new TestLevelButton();
    }
    ...
    public void clicked() {
        ...
        ((LevelEditorScene)(scene)).exportLevelEditorData();;
