...
public class LoadLevelButton extends JButton {

    String text = "Load Level";
    ...
    public String serialize(int tabSize) {
        ...
        builder.append(beginObjectProperty("LoadLevelButton", tabSize));
        builder.append(closeObjectProperty(tabSize));
        return builder.toString();
    }

    public static LoadLevelButton deserialize() {
        Parser.consumeEndObjectProperty();

        return new LoadLevelButton();
    }

    @Override
    public void clicked() {
        Scene scene = Window.getScene();
        scene.importLevel(Constants.CURRENT_LEVEL);
    }
